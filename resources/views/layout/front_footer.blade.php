    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3 col-lg-3 col-sm-6">
                ...
                <hr>
                <a class="footer-link"  href="{{ url('/contactPage') }}">যোগাযোগ</a><br>
                <a class="footer-link"   href="{{url('/projectsPage')}}">প্রজেক্ট সমূহ</a><br>
                <a class="footer-link"  href="{{url('/coursesPage')}}">কোর্স সমূহ </a><br>
            </div>
            <div class="col-md-3 col-lg-3 col-sm-6">
